...
{
    WASMStringWTF8 *string_obj = (WASMStringWTF8 *)str_obj;
...
{
    WASMStringWTF16 *string_obj = (WASMStringWTF16 *)str_obj;
...
static int32
wasm_stringref_obj_get_length(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
    int32 length = 0;
...
static uint8 *
wasm_stringref_obj_get_bytes(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
...
static int32
wasm_stringview_iter_obj_get_length(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
    int32 length = 0;
...
static uint8 *
wasm_stringview_iter_obj_get_bytes(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
    uint8 *string_bytes = NULL;
...
int32
wasm_stringview_wtf8_obj_get_length(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
    int32 length = 0;
...
uint8 *
wasm_stringview_wtf8_obj_get_bytes(WASMString str_obj)
{
    WASMStringWTF8 *string_obj = str_obj;
    uint8 *string_bytes = NULL;
...
uint16 *
wasm_stringview_wtf16_obj_get_bytes(WASMString str_obj)
{
...
int32
wasm_stringref_obj_measure_from_start(WASMString str_obj, EncodingFlag flag,
                                      uint32 start)
{
    int32 string_bytes_length, target_bytes_length;
    uint8 *string_bytes;

    string_bytes = wasm_stringref_obj_get_bytes(str_obj);
    string_bytes_length = wasm_stringref_obj_get_length(str_obj);
...
void *
wasm_stringref_obj_encode_with_flag(WASMString str_obj, EncodingFlag flag)
{
    int32 string_bytes_length, target_bytes_length;
    uint8 *string_bytes;
...
{
    return wasm_stringref_obj_measure_from_start(str_obj, flag, 0);
}
                   ...
                   EncodingFlag flag)
{
    ...
    if (flag == UTF8 || flag == WTF8 || flag == LOSSY_UTF8) {
        ...
        target_bytes =
            (uint8 *)wasm_stringref_obj_encode_with_flag(str_obj, flag);
        if (!target_bytes) {
            return -2;
        }
        if (bytes_length == -1) {
        ...
        bytes_length = wasm_string_measure(str_obj, flag);
        target_code_units =
            (uint16 *)wasm_stringref_obj_encode_with_flag(str_obj, flag);
        if (!target_code_units) {
            return -1;
        }
...
wasm_string_concat(WASMString str_obj1, WASMString str_obj2)
{
    ...
    string_bytes1 = wasm_stringref_obj_get_bytes(str_obj1);
    string_bytes_length1 = wasm_stringref_obj_get_length(str_obj1);
    string_bytes2 = wasm_stringref_obj_get_bytes(str_obj2);
    string_bytes_length2 = wasm_stringref_obj_get_length(str_obj2);
    target_bytes =
...
wasm_string_create_view(WASMString str_obj, StringViewType type)
{
    if (type == STRING_VIEW_WTF8 || type == STRING_VIEW_ITER) {
        ...
        target_bytes = wasm_stringref_obj_get_bytes(str_obj);
        target_bytes_length = wasm_stringref_obj_get_length(str_obj);
        target_code_units =
                    ...
                    uint32 *consumed)
{
    ...
    string_bytes = wasm_stringview_wtf8_obj_get_bytes(str_obj);
    string_bytes_length = wasm_stringview_wtf8_obj_get_length(str_obj);
                  ...
                  StringViewType type)
{
    ...
    if (type == STRING_VIEW_WTF8) {
        ...
        target_code_units = wasm_stringview_wtf16_obj_get_bytes(str_obj);
        ...
        string_bytes = wasm_stringview_iter_obj_get_bytes(str_obj);
        string_bytes_length = wasm_stringview_iter_obj_get_length(str_obj);
...
wasm_string_get_wtf16_codeunit(WASMString str_obj, int32 pos)
{
    ...
    code_units_len = wasm_string_measure(str_obj, WTF16);
    if (pos >= code_units_len) {
        return -1;
    }

    code_units = wasm_stringview_wtf16_obj_get_bytes(str_obj);
...
wasm_stringref_obj_dump(WASMString str_obj, EncodingFlag flag)
{
    ...
    str_len = wasm_string_measure(str_obj, flag);
    string_bytes = (uint8 *)wasm_stringref_obj_encode_with_flag(str_obj, flag);
